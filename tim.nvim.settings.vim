" Neovim settings (plugins managed by lazy.nvim)
set nocompatible
...
autocmd BufRead,BufNewFile *.java,*.cs,*.c,*.cpp,*.h,*.hpp,*.idl set sm mat=2
...
autocmd BufRead,BufNewFile *.ts set sw=2 tabstop=2
...
" Colors (set after colorscheme loads in init.lua)
